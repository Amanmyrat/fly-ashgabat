...
<head>
    ...
    <title>Добро пожаловать на Kupi!</title>
</head>
    ...
    <tr>
        <td style="padding: 0 24px;">
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 16px; padding: 20px;">
                <tr>
                    <td>
                        <h1 style="font-size: 26px; font-weight: 700; margin-top: 0; color: #1E2133;">Добро пожаловать на Kupi!</h1>
                        <p style="font-size: 16px; font-weight: 400; color: #1E2133;">Вы зарегистрировали учетную запись на сайте kupiavia.uz</p>
                        <p style="font-size: 16px; font-weight: 400; color: #1E2133;">Для завершения регистрации нажмите на кнопку «Активировать».</p>

                        <!-- Activation Button -->
                        <table role="presentation" cellspacing="0" cellpadding="0" style="margin: 20px auto; text-align: center;">
                            <tr>
                                <td style="text-align: center;">
                                    <a href="{{ $activationUrl }}" style="background-color: #3F5CFF; color: #ffffff; padding: 15px 30px; text-decoration: none; font-size: 18px; font-weight: bold; border-radius: 8px;">Активировать</a>
                                </td>
                            </tr>
                        </table>
                        ...
                        <!-- Support Link -->
                        <p style="font-size: 14px; font-weight: 400; color: #80849A;">В случае, если вам не удается нажать кнопку «Активировать», то перейдите по ссылке <a href="{{ $activationUrl }}" style="color: #3F5CFF; text-decoration: none;">{{ $activationUrl }}</a>.</p>
                    </td>
                </tr>
            </table>
        </td>
